...
<body>
	<form name="frn_login" action="<?php  $_SERVER['PHP_SELF'];?>" method="post">
		<table border="1" align="center" rules="groups" width="400">
			...
			<tr>
				<td colspan="2" align="right"><input type="submit" name="SUBMIT" value="Login" class="button" />
				<input type="button" name="CANCEL" value="Cancel" class="button" onclick="window.location='index.php';" /></td>
			</tr>
		</table>
	</form>
</body>
