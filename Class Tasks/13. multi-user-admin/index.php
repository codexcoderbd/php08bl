 ...
 * @website http://www.belancer.com
 * @facebbok https://www.facebook.com/amanur rahman aman
 */
...
if ($mode == "login") 
{
    ...
    } else 
    {
        ...
        try 
        {
            ...
            // execute Query
            $stmt->execute();
            $results = $stmt->fetchAll();//returning an array containing all of the resultset.
        ...
        <form class="form-horizontal" name="contact_form" id="contact_form" method="post" action="">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    Superadmin == araman/123456<br>
                    Admin == hasan/hasan<br>
                           Moderator == sufian/sufian<br>
                </div>
                    </div>
                </div>			
            </fieldset>
