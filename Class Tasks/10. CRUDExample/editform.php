<?php
	...
	if(isset($_GET['edit_id']) && !empty($_GET['edit_id']))
	{
		...
		$stmt_edit->execute(array(':uid'=>$id)); //You can add binded parameters in the array instead of useing the function bindParam() beforehand((ie - array key=>field name).
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="www.w3schools.com" title='Programming Blog'>&lt;W#Schools&gt;</a>
            <a class="navbar-brand" href="www.w3schools.com">CRUD</a>
            <a class="navbar-brand" href="www.w3schools.com">PDO</a>
            <a class="navbar-brand" href="www.w3schools.com">jQuery</a>
        </div>
