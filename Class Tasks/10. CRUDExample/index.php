<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		unlink("user_images/".$imgRow['userPic']); //The unlink() function deletes a file.
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="http://www.w3schools.com" title='Programming Blog'>&lt;W3shools&gt;</a>
            <a class="navbar-brand" href="http://www.w3schools.com">CRUD</a>
            <a class="navbar-brand" href="http://www.w3schools.com">PDO</a>
            <a class="navbar-brand" href="http://www.w3schools.com">jQuery</a>
        </div>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<div class="col-xs-3">
				...
				<img src="user_images/<?php echo $row['userPic']; ?>" class="img-rounded" width="150px" height="100px" />
				<p class="page-header">
				<span>
